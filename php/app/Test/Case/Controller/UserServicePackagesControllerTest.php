<?php
App::uses('UserServicePackagesController', 'Controller');

/**
 * UserServicePackagesController Test Case
 *
 */
class UserServicePackagesControllerTest extends ControllerTestCase {
