<div class="languages index">
	...
	<tr>
		...
		<td><?php echo h($language['Language']['is_blocked']); ?>&nbsp;</td>
		<td><?php echo h($language['Language']['is_deleted']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $language['Language']['id']), array(), __('Are you sure you want to delete # %s?', $language['Language']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
