<div class="serviceFaqs index">
	...
	<tr>
		<td><?php echo h($serviceFaq['ServiceFaq']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $serviceFaq['ServiceFaq']['id']), array(), __('Are you sure you want to delete # %s?', $serviceFaq['ServiceFaq']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
