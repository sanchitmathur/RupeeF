        ...
        <div class="container">
			<div class="row">
				<div class="col-md-12 service_body">
					<h1>Safety Confidentiality<span>We value the trust you place in us. That's why we insist upon the highest standards for secure transactions and customer information privacy. Please read the following statement to learn about our information gathering and dissemination practices.</span></h1>
					<p class="note"><span>Note:</span> Our privacy policy is subject to change at any time without notice. To make sure you are aware of any changes, please review this policy periodically. By visiting this Website you agree to be bound by the terms and conditions of this Privacy Policy. If you do not agree please do not use or access our Website.
					...
					<div class="trems_condisation">
						<div class="tremsText">
							...
							<p>If you choose to place order on the Website, we collect information about your ordering behaviour.</p>
						...
						<div class="tremsText">
							...
							<p>Our Website links to other websites that may collect personally identifiable information about you. Rupeeforadian.com is not responsible for the privacy practices or the content of those linked websites.</p>
						</div>
						<div class="tremsText">
							<h3>5. Intellectual Property, Software and Content </h3>
							<p>The intellectual property rights in all software and content made available to you through our website remains the property of Rupeeforadian.com and are protected by copyright laws and treaties around the world. All such rights are reserved by Laundry Industry. You may store, print and display the content supplied solely for your own personal use. You are not permitted to publish, manipulate, distribute or otherwise reproduce, in any format, any of the content or copies of the content supplied to you or which appears on this Website nor may you use any such content in connection with any business or commercial enterprise. You shall not modify, translate, reverse engineer, decompile, disassemble or create derivative works based on any software or accompanying documentation supplied by Washinggtonne.com.</p>
						</div>
						<div class="tremsText">
							<h3>6. Security Precautions</h3>
							<p>Our Website has stringent security measures in place to protect the loss, misuse, and alteration of the information under our control. Whenever you change or access your account information, we offer the use of a secure server. Once your information is in our possession we adhere to strict security guidelines, protecting it against unauthorized access.</p>
						</div>
						<div class="tremsText">
							<h3>7. Prohibitions </h3>
							<p>You must not misuse this Website. You will not: commit or encourage a criminal offence; transmit or distribute a virus, trojan, worm, logic bomb or any other material which is malicious, technologically harmful, in breach of confidence or in any way offensive or obscene; hack into any aspect of the Services; corrupt data; cause annoyance to other users; infringe upon the rights of any other person’s proprietary rights; send any unsolicited advertising or promotional material, commonly referred to as “spam”; or attempt to affect the performance or functionality of any computer facilities of or accessed through this Website. Breaching this provision would constitute a criminal offence under The Information Technology Act, 2008. Rupeeforadian.com will report any such breach to the relevant law enforcement authorities and disclose your identity to them.</p>
						</div>
						<div class="tremsText">
							<h3>8. Choice/Opt-Out</h3>
							...
							<p>If you want to remove your contact information from all Rupeeforadian.com lists and newsletters, please email to <a href="javascript:void(0);">customercare@rupeeforadian.com</a></p>
						</div>
						<div class="tremsText">
							<h3>9. Advertisements on Rupeeforadian.com</h3>
						...
						<div class="tremsText">
							...
							<p>In accordance with Information Technology Act 2008 and rules made there under, the name and contact details of the Grievance Officer are provided below:</p>
							<p>Mr. Sandeep Kumar</p>
							<p>Rupee foradian Private Limited. <br/>L-16, Sri Niwas Puri, <br/>New Delhi - 110065</p>
							<p>Phone: +91 - 8130666711 <br/>Email: customercare@rupeeforadian.com <br/>Time: Mon - Sat (9:00 - 18:00)</p>
						</div>
						<div class="tremsText">
							<h3>12. Questions?</h3>
							<p>Please send an email to us at contact us customercare@rupeeforadian.com at regarding any questions regarding this statement.</p>
						</div>
						<div class="crl"></div>
					</div>
