        ...
        <div class="container">
			<div class="row">
				<div class="col-md-12 service_body">
					<h1>Safety Confidentiality<span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text </span></h1>
					...
					<div class="trems_condisation">
						<div class="tremsText">
							...
							<h4>Wherein, you understand that:</h4>
							<ul class="trems_nav">
								...
								<li>ou are responsible for maintaining the confidentiality of any login information associated with any account you use to access our Resources. Accordingly, you are responsible for all activities that occur under your account/s.</li>
