...
<?php echo $this->Form->create('ServicePackage'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Service Package'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ServicePackage.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ServicePackage.id'))); ?></li>
